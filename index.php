...
<body>
<div id="content">
<div id="title" align="center">INVOICE</div>
<div id="body">
...
<div id="name"><input name="bank" placeholder=" Name of your Bank" type="text" /></div>
<div id="name"><input name="iban" placeholder="Account number" type="text" /></div>
<div id="name"><input name="paypal" placeholder="PayPal address" type="text" /></div>
...
<div id="footer" align="center">Created by Harsh</div>
</body>
</html>	
